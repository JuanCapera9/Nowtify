    ...
    def add_routes(self):
        ...
        def add_usuario():
            if request.method == 'POST':
                ...
                cur = self.mysql.connection.cursor()
                cur.execute('INSERT INTO usuarios (correo, nombre_usuario, contraseña, fecha_registro, id_estado_usuario, id_rol) VALUES (%s, %s, %s, %s, %s, %s)', 
                            (correo, nombre_usuario, contraseña, fecha_registro, id_estado_usuario, id_rol))
            ...
            if request.method == 'POST':
                ...
                cur.execute("""
                    ...
                    SET correo = %s,
                        ...
                        id_rol = %s
                    WHERE id_usuario = %s
                """, (correo, nombre_usuario, contraseña, id_estado_usuario, id_rol, id_usuario))
                self.mysql.connection.commit()
